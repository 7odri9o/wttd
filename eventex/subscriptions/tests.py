...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        email = mail.outbox[0]
        self.assertIn('Nome Sobrenome', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('nome.sobrenome@email.com.br', email.body)
...
class SubscribeSuccessMessage(TestCase):
    def test_message(self):
        data = dict(name='Eventex Teste', cpf='12345678901',
                    email='ventex-rodrigorocha-teste@maildrop.cc',
                    phone='11-12345-5678')
